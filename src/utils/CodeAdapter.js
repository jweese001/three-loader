...
export class CodeAdapter {
    constructor() {
        ...
        // Detection patterns for three-loader generated files (should NOT be adapted)
        this.threeLoaderPatterns = {
            generatedHeader: /Generated by 3\/LOADER|three-loader/i,
            sceneComponents: /const sceneComponents = \{/,
            exportFunction: /export async function initializeScene/,
    ...
    analyzeCode(code) {
        ...
        Object.values(this.threeLoaderPatterns).forEach(pattern => pattern.lastIndex = 0);
        
        // First check if this is a three-loader generated file (should NOT be adapted)
        analysis.isThreeLoaderGenerated = 
            this.threeLoaderPatterns.sceneComponents.test(code) ||
            this.threeLoaderPatterns.exportFunction.test(code) ||
            this.threeLoaderPatterns.apiRegistry.test(code) ||
            (this.threeLoaderPatterns.generatedHeader.test(code) && this.threeLoaderPatterns.objectManager.test(code));
        
        if (analysis.isThreeLoaderGenerated) {
            console.log('🎯 Detected three-loader generated file - skipping adaptation');
            analysis.isStandalone = false;
            analysis.confidence = 0;
        } else {
            // Test for standalone patterns only if not a three-loader file
            ...
            if (analysis.hasExportStatements) confidenceFactors += 1;
        ...
        if (this.debugMode) {
            console.log('🔍 Code Analysis Results:', {
                ...
                isThreeLoaderGenerated: analysis.isThreeLoaderGenerated,
                ...
                patterns: {
                    ...
                    exports: analysis.hasExportStatements
                },
    ...
    removeConflictingCode(code) {
        ...
        // Remove export statements - convert to regular function declarations
...
`;
    ...
    createAnimationPreservedCode(code, analysis) {
        ...
        // Remove export statements - convert to regular function declarations
        preservedCode = preservedCode.replace(/^export\s+(async\s+)?function\s+/gm, '$1function ');
